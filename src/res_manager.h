...
enum TEXTURES{BACKGROUND=0,FLOOR,LABEL,BIRD_1,INSTRUCTIONS=BIRD_1+3,PIPE_UP,PIPE_DOWN,LARGE_NUMBERS,MIDDLE_NUMBERS=LARGE_NUMBERS+10,SCORE_PANNEL=MIDDLE_NUMBERS+10,BUTTON_PAUSE};
